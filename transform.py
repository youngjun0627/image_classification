...
def create_train_transform(flip,\
    ...
    ### resize
    if resize:
        translist+=[albumentations.Resize(size+30,300)] ## original image width : 300
    ...
    ### normalized & totensor
    translist+=[albumentations.Normalize(mean = (0.4859, 0.5137, 0.5416), std = (0.2178, 0.2138, 0.2253))] # 위에서 구한 값으로 
    translist+=[ToTensor()]
